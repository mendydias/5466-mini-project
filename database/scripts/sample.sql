/*
	...
	Reg_num: 321424374
	Email: s92064374@ousl.lk
*/

-- Insert sample data to populate multi-valued entities
USE empdb;
GO
...
(1873, 5, 'St. Anthonys', 'ශාන්ත අන්තෝනි', 'புனித அந்தோணியார்', NULL, NULL, NULL, '01183', '6.93171040', '79.87376180'),
...
INSERT INTO main.departments (name)
VALUES 
('Finance'),
('Human Resources'),
('Marketing'),
...
VALUES 
('Saman Silva', 'Something', 4),
('Chamari Perera', 'Developer', 1),
('Nuwan Fernando', 'Designer', 2),
('Nilmini de Silva', 'Analyst', 3),
('Dinesh Gunawardena', 'Engineer', 4),
('Malini Fonseka', 'Administrator', 5),
('Rohan Bandara', 'Consultant', 2),
('Chathuri Rajapaksa', 'Coordinator', 6),
('Lakmal Perera', 'Specialist', 6),
('Ishara Ranasinghe', 'Assistant', 7),
('Ramesh de Alwis', 'Supervisor', 8),
('Chandima Peiris', 'Technician', 9),
...
VALUES 
('123', 'Galle Road', 349),
('456', 'Kandy Street', 1678),
('789', 'Matara Lane', 1203),
('101', 'Jaffna Avenue', 942),
('202', 'Anuradhapura Mawatha', 128),
('303', 'Polonnaruwa Drive', 1319),
('505', 'Badulla Road', 1567),
('606', 'Nuwara Eliya Street', 1443),
('707', 'Trincomalee Avenue', 1165),
('808', 'Gampaha Boulevard', 187),
('909', 'Batticaloa Lane', 722),
...
VALUES 
(1, 1, '2023-01-01 08:45:00'),
(2, 2, '2024-02-02 09:30:00'),
(3, 3, '2022-03-03 10:15:00'),
(4, 4, '2023-04-04 11:00:00'),
(5, 5, '2024-05-05 12:15:00'),
(6, 6, '2022-06-06 13:30:00'),
(7, 7, '2023-07-07 14:45:00'),
(8, 8, '2024-08-08 08:30:00'),
(9, 9, '2022-09-09 09:45:00'),
(10, 9, '2023-10-10 10:30:00'),
(11, 10, '2024-11-11 11:15:00'),
(12, 11, '2022-12-12 12:00:00'),
...
VALUES 
(1234567890, 1, 1, 130, 1),
(2345678901, 1, 0, 130, 2),
(3456789012, 1, 1, 130, 3),
(4567890123, 1, 0, 130, 4),
(5678901234, 1, 1, 130, 5),
(6789012345, 1, 0, 130, 6),
(7890123456, 1, 1, 130, 7),
(8901234567, 1, 0, 130, 8),
(9012345678, 1, 1, 130, 9),
(1234567890, 1, 0, 130, 10),
(2345678901, 1, 1, 130, 11),
(3456789012, 1, 0, 130, 12),
...
VALUES 
('saman.silva@ousl.lk', 1),
('chamari.perera@ousl.lk', 2),
('nuwan.fernando@ousl.lk', 3),
('nilmini.desilva@ousl.lk', 4),
('dinesh.gunawardena@ousl.lk', 5),
('malini.fonseka@ousl.lk', 6),
('rohan.bandara@ousl.lk', 7),
('chathuri.rajapaksa@ousl.lk', 8),
('lakmal.perera@ousl.lk', 9),
('ishara.ranasinghe@ousl.lk', 10),
('ramesh.dealwis@ousl.lk', 11),
('chandima.peiris@ousl.lk', 12),
...
(4, 8, '2023-07-28 16:40:00'),
(10, 5, '2024-01-05 08:15:00'),
(3, 9, '2025-09-12 12:30:00'),
(5, 1, '2026-06-20 14:55:00'),
(13, 2, '2027-04-02 18:10:00'),
(2, 8, '2028-10-30 20:45:00'),
(1, 4, '2029-02-18 22:20:00'),
(9, 7, '2030-11-11 09:35:00'),
(7, 6, '2031-05-25 11:50:00'),
(13, 9, '2032-08-08 04:05:00'),
(11, 3, '2033-12-22 06:20:00'),
(5, 6, '2034-03-09 01:35:00'),
(14, 3, '2035-07-14 03:50:00'),
(15, 1, '2036-09-01 07:05:00'),
(6, 9, '2037-06-11 19:20:00'),
(10, 6, '2038-04-16 21:35:00'),
...
(1, 4, '2024-04-10 10:00:00'),
(3, 2, '2022-02-23 08:45:00'),
(2, 1, '2024-01-20 11:15:00'),
(4, 3, '2023-03-28 09:20:00'),
