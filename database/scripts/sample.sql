...
insert into "provinces" ("province_id", "name_en", "name_si", "name_ta", "country_id") values
...
insert into "districts" ("district_id", "province_id", "name_en", "name_si", "name_ta") values
...
insert into "cities" ("city_id", "district_id", "name_en", "name_si", "name_ta", "subname_en", "subname_si", "subname_ta", "postcode", "latitude", "longitude") values
...
copy into countries from '/scripts/countries.csv' with (fieldterminator = ',', file_type = 'csv');
